...
class Number:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_number(self)
...
class Function:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_function(self)
...
class FunctionDefinition:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_function_definition(self)
...
class Conditional:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_condition(self)
...
class Print:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_print(self)
...
class Read:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_read(self)
...
class FunctionCall:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_function_call(self)
...
class Reference:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_reference(self)
...
class BinaryOperation:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_binary_operation(self)
...
class UnaryOperation:
    ...
    def accept(self, pure_check_visitor):
        return pure_check_visitor.visit_unary_operation(self)
